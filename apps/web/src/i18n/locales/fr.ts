...
export const fr: Dict = {
  ...
  'settings.cliEnvHint': 'Optionnel — uniquement pour un proxy personnalisé ou un chemin d’installation non standard. Stocké en local, utilisé uniquement par ce CLI.',
